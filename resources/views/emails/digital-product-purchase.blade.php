...
<head>
    ...
    <style>
        ...
        .header { background-color: #e53637; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0; }
        ...
        .receipt { color: #666; font-size: 14px; margin-bottom: 20px; }
        .btn { display: inline-block; background-color: #e53637; color: white; padding: 14px 28px; text-decoration: none; border-radius: 5px; font-weight: bold; margin: 15px 0; }
        .btn:hover { background-color: #c42d2e; }
        .footer { margin-top: 20px; padding-top: 20px; border-top: 1px solid #ddd; text-align: center; color: #666; font-size: 12px; }
        .order-number { color: #e53637; font-weight: bold; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="content">
        ...
        <div class="receipt">Receipt #{{ $receiptId }}</div>
        @if($orderItem->order)
