<div>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="{{ asset('bootstrap/img/hero/hero-1.jpg') }}">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero__items set-bg" data-setbg="{{ asset('bootstrap/img/hero/hero-2.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="{{ asset('bootstrap/img/banner/banner-1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="{{ asset('bootstrap/img/banner/banner-2.jpg') }}" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Accessories</h2>
                            <a href="#">Shop now</a>
                ...
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="{{ asset('bootstrap/img/banner/banner-3.jpg') }}" alt="">
                        </div>
                        <div class="banner__item__text">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="categories__hot__deal">
                        <img src="{{ asset('bootstrap/img/product-sale.png') }}" alt="">
